...
<template>
  <div class="pb-48">
    <div class="text-sx leading-loose">
      <h3 class="filter_heading pt-[10px] text-[10px] !font-[600] text-black">Filter By Case Color</h3>
    ...
    <div class="text-sx leading-loose">
      <h3 class="filter_heading pt-[10px] text-[10px] !font-[600] text-black">Filter By Dial Color</h3>
      <div class="flex flex-wrap gap-[10px]">
        <div class="">
          <button class="relative transform cursor-pointer text-center transition-transform duration-200 hover:scale-105">
    ...
    <div class="text-sx leading-loose">
      <h3 class="filter_heading pt-[10px] text-[10px] !font-[600] text-black">Filter By Dial Design</h3>
      <div class="flex flex-wrap gap-[10px]">
        <div class="">
          <button class="relative transform cursor-pointer text-center transition-transform duration-200 hover:scale-105">
    ...
    <div class="text-sx border-b-2 border-[#e4e3ea] leading-loose">
      <h3 class="filter_heading pt-[10px] text-[10px] !font-[600] text-black">Filter By Strap Design</h3>
      <div class="flex flex-wrap gap-[10px]">
        <div class="">
          <button class="relative transform cursor-pointer text-center transition-transform duration-200 hover:scale-105">
